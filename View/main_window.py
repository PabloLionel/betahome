...
"border-radius: 6px;")
        ...
        self.Label_Saldo.setStyleSheet("font: 87 11pt \"Roboto Black\";")
...
"")
        ...
        self.tabla_cuentas.verticalHeader().setDefaultSectionSize(32)
        self.tabla_cuentas.verticalHeader().setMinimumSectionSize(32)
...
"")
        ...
        self.tableWidget_categorias = QtWidgets.QTableWidget(self.categorias_frame)
        self.tableWidget_categorias.setGeometry(QtCore.QRect(70, 60, 141, 501))
        self.tableWidget_categorias.setStyleSheet("border-color:#6b778d;\n"
"border-style: solid;\n"
"border-width: 2px;\n"
"border-radius: 3px;\n"
"font: 8pt \"Roboto\";")
        self.tableWidget_categorias.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.tableWidget_categorias.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        self.tableWidget_categorias.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        ...
        self.tableWidget_categorias.horizontalHeader().setDefaultSectionSize(150)
        self.tableWidget_categorias.horizontalHeader().setMinimumSectionSize(100)
        self.tableWidget_nombresdecuentas = QtWidgets.QTableWidget(self.categorias_frame)
        self.tableWidget_nombresdecuentas.setGeometry(QtCore.QRect(250, 130, 151, 321))
        self.tableWidget_nombresdecuentas.setStyleSheet("border-color:#6b778d;\n"
"border-style: solid;\n"
"border-width: 2px;\n"
"border-radius: 3px;\n"
"font: 8pt \"Roboto\";")
        self.tableWidget_nombresdecuentas.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.tableWidget_nombresdecuentas.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tableWidget_nombresdecuentas.setObjectName("tableWidget_nombresdecuentas")
        self.tableWidget_nombresdecuentas.setColumnCount(1)
        self.tableWidget_nombresdecuentas.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setFamily("Roboto")
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        item.setForeground(brush)
        self.tableWidget_nombresdecuentas.setHorizontalHeaderItem(0, item)
        self.tableWidget_nombresdecuentas.horizontalHeader().setDefaultSectionSize(150)
        self.tableWidget_nombresdecuentas.horizontalHeader().setMinimumSectionSize(150)
        self.tableWidget_nombresdecuentas.verticalHeader().setMinimumSectionSize(30)
        self.label_5 = QtWidgets.QLabel(self.categorias_frame)
        self.label_5.setGeometry(QtCore.QRect(470, 310, 61, 21))
        self.label_5.setStyleSheet("background-color: transparent;\n"
"font: 12pt \"Roboto\";")
        self.label_5.setAlignment(QtCore.Qt.AlignCenter)
        self.label_5.setObjectName("label_5")
        self.lineEdit_ingres_monto_categoria_item = QtWidgets.QLineEdit(self.categorias_frame)
        self.lineEdit_ingres_monto_categoria_item.setGeometry(QtCore.QRect(430, 270, 141, 31))
        self.lineEdit_ingres_monto_categoria_item.setStyleSheet("font: 12pt \"Roboto\";\n"
"background-color: transparent;\n"
"border-bottom: 2px black;\n"
"color: black;\n"
"border-style: solid;")
        self.lineEdit_ingres_monto_categoria_item.setMaxLength(20)
        self.lineEdit_ingres_monto_categoria_item.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_ingres_monto_categoria_item.setObjectName("lineEdit_ingres_monto_categoria_item")
        self.pushButton_actualizar_mont_categoria = QtWidgets.QPushButton(self.categorias_frame)
        self.pushButton_actualizar_mont_categoria.setGeometry(QtCore.QRect(460, 340, 81, 25))
        self.pushButton_actualizar_mont_categoria.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButton_actualizar_mont_categoria.setStyleSheet("background-color: #6b778d;\n"
"border-radius: 6px;\n"
"font: 87 8pt \"Roboto Black\";\n"
"color: rgb(255, 255, 255);")
        self.pushButton_actualizar_mont_categoria.setObjectName("pushButton_actualizar_mont_categoria")
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "Categoría"))
        item = self.tableWidget_nombresdecuentas.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Nombre de la cuenta"))
        self.label_5.setText(_translate("Form", "Monto"))
        self.lineEdit_ingres_monto_categoria_item.setPlaceholderText(_translate("Form", "$ 00000.00"))
        self.pushButton_actualizar_mont_categoria.setText(_translate("Form", "Actualizar"))
