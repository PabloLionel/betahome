...
class add_cuenta(QMainWindow, Ui_agregar_cuenta):
	def __init__(self, parent = None):
		super(add_cuenta, self).__init__(parent)
		self.setupUi(self)

class add_saldo(QMainWindow, Ui_Form_saldo):
	def __init__(self, parent = None):
		super(add_saldo, self).__init__(parent)
		self.setupUi(self)
