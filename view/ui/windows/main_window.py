...
"border-radius: 6px;")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("view/ui/windows/icon_img/icons8-positive-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"padding-left: 30px;")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("view/ui/windows/icon_img/icons8-google-home-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"padding-left: 30px;")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("view/ui/windows/icon_img/icons8-spreadsheet-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"padding-left: 30px;")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("view/ui/windows/icon_img/icons8-sorting-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"padding-left: 30px;")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("view/ui/windows/icon_img/icons8-statistics-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"padding-left: 30px;")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("view/ui/windows/icon_img/icons8-doughnut-chart-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"padding-left: 30px;")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("view/ui/windows/icon_img/icons8-help-48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_2.setPixmap(QtGui.QPixmap("view/ui/windows/beta_img/Logo_oficial_vector_bl.png"))
        ...
        self.label_7.setPixmap(QtGui.QPixmap("view/ui/windows/beta_img/Logo_oficial_vector_bl.png"))
...
"")
        ...
        self.label_3.setPixmap(QtGui.QPixmap("view/ui/windows/icon_img/icons8-us-dollar-30.png"))
        ...
        self.label_11.setPixmap(QtGui.QPixmap("view/ui/windows/beta_img/Logo_oficial_vector_bl.png"))
        ...
        self.label_13.setPixmap(QtGui.QPixmap("view/ui/windows/beta_img/Logo_oficial_vector_bl.png"))
        ...
        self.label_17.setPixmap(QtGui.QPixmap("view/ui/windows/beta_img/Logo_oficial_vector_bl.png"))
